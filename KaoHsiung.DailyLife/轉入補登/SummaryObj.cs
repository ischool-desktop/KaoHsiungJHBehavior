...
namespace KaoHsiung.DailyLife
{
    class SummaryObj
    {
        ...
        public SummaryObj(XmlElement xml)
        {
            _xml = xml;
        ...
        private void AttendanceStatisticsSetup()
        {
            if (_xml.SelectSingleNode("AttendanceStatistics") != null)
            {
                ...
                {
                    AttendanceObj obj = new AttendanceObj(each);
                    AttendanceList.Add(obj);
                }
            }
        }

        public List<AttendanceObj> AttendanceList = new List<AttendanceObj>();
        ...
        public XmlElement GetAllXmlElement()
        {
            ...
            if (AttendanceList.Count != 0)
            {
                ...
                foreach (AttendanceObj each in AttendanceList)
                {
